...
/**
 * リポジトリプロバイダのひな型のmakeコマンド
 */
final class MakeRepositoryProviderCommand extends GeneratorCommand
{
    use StubsFindable;
     ...
     * @var string
     */
    protected $description = 'Create a new repository provider';

    /**
     * @var string
     */
    protected $type = 'Repository provider';
    ...
    {
        return $this->resolveStubPath('repository/repository.provider.stub');
    }
    ...
    {
        return $this->getEntityInput() . 'RepositoryServiceProvider';
    }
