...
/**
 * リポジトリ実装のひな型のmakeコマンド
 */
final class MakeRepositoryImplementsCommand extends GeneratorCommand
{
    use StubsFindable;
     ...
     * @var string
     */
    protected $name = 'make:repository-implements';
     ...
     * @var string
     */
    protected $description = 'Create a new repository implements';

    /**
     * @var string
     */
    protected $type = 'Repository implements';
    ...
    {
        return $this->resolveStubPath('repository/repository.implements.stub');
    }
    ...
    {
        return $this->getEntityInput() . 'RepositoryImpl';
    }
    ...
    public function handle(): bool
    {
        ...
        $this->call('repository:register', [
            ...
            'interface' => "{$this->rootNamespace()}Contexts\\{$this->getContextInput()}\\Domain\\Persistence\\{$this->getEntityInput()}Repository",
        ]);
