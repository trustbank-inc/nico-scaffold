...
/**
 * 一覧検索リポジトリプロバイダのひな型のmakeコマンド
 */
final class MakeSearchRepositoryProviderCommand extends GeneratorCommand
{
    use StubsFindable;
     ...
     * @var string
     */
    protected $name = 'make:search-repository-provider';
     ...
     * @var string
     */
    protected $description = 'Create a new search repository provider';

    /**
     * @var string
     */
    protected $type = 'Search Repository provider';
    ...
    {
        return $this->resolveStubPath('repository/search-repository.provider.stub');
    }
    ...
    {
        return $rootNamespace . "\\Providers\\Contexts\\{$this->getContextInput()}";
    }
    ...
    {
        return 'Search' . $this->getEntityInput() . 'ListRepositoryServiceProvider';
    }
