...
/**
 * 一覧検索リポジトリのひな型のmakeコマンド
 */
final class MakeSearchRepositoryCommand extends GeneratorCommand
{
    use StubsFindable;
     ...
     * @var string
     */
    protected $name = 'make:search-repository';
     ...
     * @var string
     */
    protected $description = 'Create a new search repository interface';

    /**
     * @var string
     */
    protected $type = 'SearchRepository';
    ...
    {
        return $this->resolveStubPath('repository/search-repository.interface.stub');
    }
    ...
    {
        return 'Search' . $this->getEntityInput() . 'ListRepository';
    }
    ...
    public function handle(): bool
    {
        ...
        $this->call('make:search-repository-implements', $this->arguments());

        $params = [
            'context' => $this->getContextInput(),
            'entity' => $this->getEntityInput(),
        ];
        $this->call('make:search-repository-provider', $params);
        return true;
    }
