...
final class MakeInteractorOutputCommand extends GeneratorCommand
{
    use StubsFindable;
     ...
     * @var string
     */
    protected $name = 'make:interactor-output';
     ...
     * @var string
     */
    protected $description = 'Create a new output for interactor';

    /**
     * @var string
     */
    protected $type = 'Interactor output';
    ...
    {
        return $this->resolveStubPath('interactor.output.stub');
    }
